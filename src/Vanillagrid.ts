...
interface Cell extends HTMLElement, CellColInfo {
    gId: string;
    gType: string;
    cValue: any;
    row: number;
...
interface VanillagridConstructor {
    new (): Vanillagrid;
}
